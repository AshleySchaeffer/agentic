...
- Write your synthesis to `plans/synthesis.md`
- Write the shared file map to `plans/file-map.md`
- Write the challenge resolution log to `challenges/resolution-log.md`
...
6. Summary sent to main instance
