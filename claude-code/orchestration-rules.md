...
- Clean shutdown: after all work completes, shut down all teammates and clean up team state. Stale team state blocks creation of new teams — cleanup is mandatory, not optional.
