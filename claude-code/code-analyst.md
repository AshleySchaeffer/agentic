...
Write findings to your `.claude/agent-internals/findings/` file incrementally as you trace — this is your primary deliverable, not a checkpoint. If you are replaced mid-investigation, the file reflects everything discovered so far.
