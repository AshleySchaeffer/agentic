...
## Deliverable
Write your challenge report to `challenges/<phase>-challenge-report.md` (e.g., `challenges/post-synthesis-challenge-report.md`). Message the architect with a summary and the file path.
