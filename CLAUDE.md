...
| `planning-protocol.md` | (injected at runtime via EnterPlanMode hook) | Never written to disk |

### Hook handlers

| Handler | Trigger | Behavior |
|---|---|---|
| `planning_protocol` | PreToolUse/EnterPlanMode | Wipes stale worktrees; injects planning protocol + `.claude/project-config.md` contents as `additionalContext` |
